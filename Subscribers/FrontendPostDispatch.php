...
class FrontendPostDispatch implements SubscriberInterface
{
    ...
    protected function moptPayoneCheckEnvironment($controllerName = false)
    {
        ...
        $serviceGenerateHash = $this->container->get('MoptPayoneBuilder')->buildServiceClientApiGenerateHash();
        ...
        //retrieve additional creditcardconfig
        $data['moptCreditcardConfig'] = $this->getCreditcardConfig();
    ...
    protected function moptPaymentConfigParams($mandateData)
    {
        ...
        $data['moptCreditcardMinValid'] = (int) $config['creditcardMinValid'];
