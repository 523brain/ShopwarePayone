...
class Shopware_Controllers_Backend_MoptConfigPayone extends Shopware_Controllers_Backend_ExtJs
{
  ...
  {
    $data          = Shopware()->Plugins()->Frontend()->MoptPaymentPayone()->Application()->PayoneMain()->getPayoneConfig($paymentId, true, true);
    $paymentHelper = Shopware()->Plugins()->Frontend()->MoptPaymentPayone()->Application()->PayoneMain()->getPaymentHelper();
