...
class Mopt_PayoneInstallHelper
{
  ...
  public function moptUserAttributesExist()
  {
    $sql    = "SELECT * FROM INFORMATION_SCHEMA.COLUMNS
                WHERE TABLE_NAME='s_user_attributes'
  ...
  {
    $sql    = "SELECT * FROM INFORMATION_SCHEMA.COLUMNS
                WHERE TABLE_NAME='s_user_billingaddress_attributes'
  ...
  {
    $sql    = "SELECT * FROM INFORMATION_SCHEMA.COLUMNS
                WHERE TABLE_NAME='s_user_shippingaddress_attributes'
                AND COLUMN_NAME ='mopt_payone_addresscheck_result'";
    $result = Shopware()->Db()->query($sql);
  ...
  {
    $sql    = "SELECT * FROM INFORMATION_SCHEMA.COLUMNS
                WHERE TABLE_NAME='s_order_details_attributes'
