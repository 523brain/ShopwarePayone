      ...
      },
      {
        ...
        handler: function(a, b) {
          me.submit({
            ...
            failure: function() {
              Ext.Msg.alert('{s name=save/title}Zahlartkonfiguration speichern{/s}', '{s name=save/error}Die Daten konnten nicht gespeichert werden. Bitte überprüfen Sie ihre Eingaben.{/s}');
            },
            waitTitle: '{s name=message/wait}Bitte warten...{/s}',
            waitMsg: '{s name=message/processing}Daten werden verarbeitet{/s}'
          });
