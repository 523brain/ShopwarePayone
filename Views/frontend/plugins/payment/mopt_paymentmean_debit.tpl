...
<div class="payment--form-group">
    ...
    <input name="moptPaymentData[mopt_payone__debit_bankaccountholder]"
           ...
           class="payment--field is--required{if $error_flags.mopt_payone__debit_bankaccountholder} has--error{/if}" />
    ...
    <input name="moptPaymentData[mopt_payone__debit_iban]"
           ...
           class="payment--field is--required{if $error_flags.mopt_payone__debit_iban} has--error{/if} moptPayoneIbanBic" />
    ...
    <input name="moptPaymentData[mopt_payone__debit_bic]"
           ...
           data-moptIbanErrorMessage="{s namespace='frontend/MoptPaymentPayone/errorMessages' name="ibanbicFormField"}Dieses Feld darf nur Großbuchstaben und Ziffern enthalten{/s}"
           class="payment--field is--required{if $error_flags.mopt_payone__debit_bic} has--error{/if} moptPayoneIbanBic" />
    ...
    {if $moptPaymentConfigParams.moptShowAccountnumber}
        ...
        <input name="moptPaymentData[mopt_payone__debit_bankaccount]"
               ...
               class="payment--field is--required{if $error_flags.mopt_payone__debit_bankaccount} has--error{/if} moptPayoneNumber" />
        ...
        <input name="moptPaymentData[mopt_payone__debit_bankcode]"
               ...
               class="payment--field is--required{if $error_flags.mopt_payone__debit_bankcode} has--error{/if} moptPayoneBankcode" />
    {/if}
