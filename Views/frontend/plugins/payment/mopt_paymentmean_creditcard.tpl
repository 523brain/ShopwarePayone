...
<div id="moptSavePayment{$payment_mean.id}" class="grid_9 bankdata" 
    ...
    <input type="submit" style="float:right; margin-right: 0px;" onclick="checkCreditCard();
            return false;" 
  ...
  <!--
    ...
    if(externalJsEnabled) {
                        ...
                        function checkCreditCard()
                        {
                            ...
                            var today = new Date();
                            var minValidDate = new Date(today.getFullYear(), today.getMonth(), today.getDate() + {$moptPaymentConfigParams.moptCreditcardMinValid});
