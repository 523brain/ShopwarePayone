<div class="debit">
  <p class="none">
    <label for="mopt_payone__eps_bankgrouptype">{*s name='PaymentDebitLabelName'}{/s*}Bankgruppe</label>
    <select name="moptPaymentData[mopt_payone__eps_bankgrouptype]" id="mopt_payone__eps_bankgrouptype" size="1" style="width:auto" class="{if $error_flags.mopt_payone__eps_bankgrouptype}instyle_error{/if}">
