...
class Shopware_Controllers_Frontend_MoptPaymentPayone extends Shopware_Controllers_Frontend_Payment
{
  ...
  protected function mopt_payone__paypal()
  {
    ...
    $response = $this->buildAndCallPayment($config, 'wlt', $payment, $moptPaypalEcsWorkerId );
  ...
  public function finishOrderAction()
  {
    ...
    $this->redirect(array('controller' => 'checkout', 'action' => 'finish', 'sUniqueID'  => $txId));
  }
   ...
   */
  protected function buildAndCallPayment($config, $clearingType, $payment, $workerId = false)
  {
  ...
  public function downloadErrorAction()
  {
    ...
    /**
     * check if a recurring order is processed, used for abo commerce
     * 
     * @return bool
     */
    ...
    /**
     * CheckIfTxIdIsAlreadySetAndEqualsSessionVar
     * 
     * @return boolean 
     */
