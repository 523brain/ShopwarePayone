...
class Mopt_PayoneInstallHelper
{
    ...
    {
        Shopware()->Models()->addAttribute('s_order_attributes', 'mopt_payone', 'payment_reference', 'VARCHAR(100)', 
                true, null);
        Shopware()->Models()->addAttribute('s_order_attributes', 'mopt_payone', 'order_hash', 'VARCHAR(255)', 
                true, null);
